...
/// </summary>
public enum PresetProfile { Potato, Stability, Low, Medium, High }
...
public sealed class GameTarget
{
    ...
    /// <summary>Any backup we have ever written, including under the app's previous names.</summary>
    public bool HasBackup => Detected && new[] { ".viskatweak.bak", ".fivemtweaks.bak", ".rigbooster.bak" }
        .Any(suffix => System.IO.File.Exists(SettingsPath + suffix));
}
