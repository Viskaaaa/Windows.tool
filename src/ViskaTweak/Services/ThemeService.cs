...
public static class ThemeService
{
    ...
    public static void Apply(AppTheme theme, double fontScale)
    {
        ...
        var uri = new Uri(theme == AppTheme.HighContrast
            ? "pack://application:,,,/ViskaTweak;component/Themes/Palette.HighContrast.xaml"
            : "pack://application:,,,/ViskaTweak;component/Themes/Palette.Red.xaml", UriKind.Absolute);
