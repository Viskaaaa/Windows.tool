...
public static class InstallService
{
    private const string UninstallKey =
        @"Software\Microsoft\Windows\CurrentVersion\Uninstall\FiveMTweaks";

    public const string ProductName = "FiveM Tweaks";

    public static string InstallFolder => Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "FiveM Tweaks");

    public static string InstalledExe => Path.Combine(InstallFolder, "FiveMTweaks.exe");
    ...
    public static TweakResult Uninstall()
    {
        ...
        try
        {
            ...
            using (var key = Registry.CurrentUser.OpenSubKey(
                ...
                key?.DeleteSubKeyTree("FiveMTweaks", throwOnMissingSubKey: false);
